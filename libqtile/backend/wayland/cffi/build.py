...
extern "Python" bool add_kb_shortcuts_inhibitor_cb(void *userdata, void *inhibitor, void *surface);
extern "Python" bool remove_kb_shortcuts_inhibitor_cb(void *userdata, void *inhibitor);
