...
hooks: list[Hook] = [
    ...
    Hook(
        "idle_timeout",
        """
        Called when system becomes idle after configured timeout.
    ...
    Hook(
        "idle_resume",
        """
        Called when user activity resumes after idle timeout.
        ...
        **Arguments**
        ...
        .. code:: python
          ...
          @hook.subscribe.idle_resume
          def on_resume():
              qtile.spawn("restore-screen")
