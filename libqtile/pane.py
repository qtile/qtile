"""
Generic class allowing to display a pane (bar, notification window, etc)
Known children class: Bar
"""
...
class Pane(command.CommandObject, configurable.Configurable):
    ...
    def draw(self):
        stretches = [i for i in self.widgets if i.width_type == obj.STRETCH]
