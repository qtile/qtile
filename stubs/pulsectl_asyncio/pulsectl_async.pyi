...
class PulseAsync:
    name: Incomplete
    server: Incomplete
    def __init__(self, client_name: Incomplete | None = ..., server: Incomplete | None = ..., loop: Optional[asyncio.AbstractEventLoop] = ...) -> None: ...
    ...
    async def connect(self, autospawn: bool = ..., wait: bool = ..., timeout: Incomplete | None = ...) -> None: ...
    @property
    def connected(self): ...
    ...
    async def subscribe_peak_sample(self, source, rate: int = ..., stream_idx: Incomplete | None = ..., allow_suspend: bool = ...) -> AsyncIterator[float]: ...
    async def play_sample(self, name, sink: Incomplete | None = ..., volume: float = ..., proplist_str: Incomplete | None = ...) -> None: ...
